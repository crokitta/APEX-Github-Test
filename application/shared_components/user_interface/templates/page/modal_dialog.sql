...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(725681931127518238)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725682209849518238)
,p_page_template_id=>wwv_flow_imp.id(725681931127518238)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725682560074518238)
,p_page_template_id=>wwv_flow_imp.id(725681931127518238)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725682884087518238)
,p_page_template_id=>wwv_flow_imp.id(725681931127518238)
