...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(725671954531518230)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725672253075518231)
,p_page_template_id=>wwv_flow_imp.id(725671954531518230)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725672519782518231)
,p_page_template_id=>wwv_flow_imp.id(725671954531518230)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725672868736518231)
,p_page_template_id=>wwv_flow_imp.id(725671954531518230)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725673158594518231)
,p_page_template_id=>wwv_flow_imp.id(725671954531518230)
,p_name=>'Body Footer'
