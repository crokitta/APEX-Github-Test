...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(725754098736518289)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725754380790518290)
,p_plug_template_id=>wwv_flow_imp.id(725754098736518289)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725754643981518290)
,p_plug_template_id=>wwv_flow_imp.id(725754098736518289)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725754934837518290)
,p_plug_template_id=>wwv_flow_imp.id(725754098736518289)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725755270822518290)
,p_plug_template_id=>wwv_flow_imp.id(725754098736518289)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725755547985518290)
,p_plug_template_id=>wwv_flow_imp.id(725754098736518289)
,p_name=>'Sub Regions'
