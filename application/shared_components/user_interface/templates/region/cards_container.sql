...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(725704311089518255)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725704641614518255)
,p_plug_template_id=>wwv_flow_imp.id(725704311089518255)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725704979587518255)
,p_plug_template_id=>wwv_flow_imp.id(725704311089518255)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725705201942518256)
,p_plug_template_id=>wwv_flow_imp.id(725704311089518255)
,p_name=>'Sub Regions'
