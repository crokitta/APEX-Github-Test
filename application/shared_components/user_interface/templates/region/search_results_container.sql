...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(725761152360518294)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725761453500518294)
,p_plug_template_id=>wwv_flow_imp.id(725761152360518294)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725761754196518294)
,p_plug_template_id=>wwv_flow_imp.id(725761152360518294)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725762072940518294)
,p_plug_template_id=>wwv_flow_imp.id(725761152360518294)
,p_name=>'Sub Regions'
