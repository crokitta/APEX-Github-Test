...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(725730592214518274)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725730859816518274)
,p_plug_template_id=>wwv_flow_imp.id(725730592214518274)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725731191927518275)
,p_plug_template_id=>wwv_flow_imp.id(725730592214518274)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725731447557518275)
,p_plug_template_id=>wwv_flow_imp.id(725730592214518274)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725731761969518275)
,p_plug_template_id=>wwv_flow_imp.id(725730592214518274)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725732062122518275)
,p_plug_template_id=>wwv_flow_imp.id(725730592214518274)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
