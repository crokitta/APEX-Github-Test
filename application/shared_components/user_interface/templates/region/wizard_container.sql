...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(725781392113518306)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725781630968518307)
,p_plug_template_id=>wwv_flow_imp.id(725781392113518306)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725781958072518307)
,p_plug_template_id=>wwv_flow_imp.id(725781392113518306)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725782250249518307)
,p_plug_template_id=>wwv_flow_imp.id(725781392113518306)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725782576393518307)
,p_plug_template_id=>wwv_flow_imp.id(725781392113518306)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725782893129518307)
,p_plug_template_id=>wwv_flow_imp.id(725781392113518306)
