...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(725698611438518250)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725698957171518250)
,p_plug_template_id=>wwv_flow_imp.id(725698611438518250)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725699273037518251)
,p_plug_template_id=>wwv_flow_imp.id(725698611438518250)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725699573687518251)
,p_plug_template_id=>wwv_flow_imp.id(725698611438518250)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725699856082518251)
,p_plug_template_id=>wwv_flow_imp.id(725698611438518250)
,p_name=>'Sub Regions'
