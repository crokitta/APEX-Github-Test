...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(725758660643518292)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725758939113518292)
,p_plug_template_id=>wwv_flow_imp.id(725758660643518292)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725759205493518293)
,p_plug_template_id=>wwv_flow_imp.id(725758660643518292)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725759576294518293)
,p_plug_template_id=>wwv_flow_imp.id(725758660643518292)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725759884277518293)
,p_plug_template_id=>wwv_flow_imp.id(725758660643518292)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725760100477518293)
,p_plug_template_id=>wwv_flow_imp.id(725758660643518292)
,p_name=>'Sub Regions'
