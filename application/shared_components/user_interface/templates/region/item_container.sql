...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(725756120024518291)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725756498472518291)
,p_plug_template_id=>wwv_flow_imp.id(725756120024518291)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725756712992518291)
,p_plug_template_id=>wwv_flow_imp.id(725756120024518291)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725757069866518291)
,p_plug_template_id=>wwv_flow_imp.id(725756120024518291)
,p_name=>'Button Start'
