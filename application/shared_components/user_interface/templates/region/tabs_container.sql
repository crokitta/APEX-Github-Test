...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(725773681542518302)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725773922378518302)
,p_plug_template_id=>wwv_flow_imp.id(725773681542518302)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725774206767518302)
,p_plug_template_id=>wwv_flow_imp.id(725773681542518302)
,p_name=>'Tabs'
