...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(725697285194518249)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725697571645518250)
,p_plug_template_id=>wwv_flow_imp.id(725697285194518249)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725697801931518250)
,p_plug_template_id=>wwv_flow_imp.id(725697285194518249)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725698108843518250)
,p_plug_template_id=>wwv_flow_imp.id(725697285194518249)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(725698412978518250)
,p_plug_template_id=>wwv_flow_imp.id(725697285194518249)
,p_name=>'Sub Regions'
