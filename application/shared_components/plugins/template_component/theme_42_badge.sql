...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(725848132901518366)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(725848455898518370)
,p_plugin_id=>wwv_flow_imp.id(725848132901518366)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(725848707600518370)
,p_plugin_id=>wwv_flow_imp.id(725848132901518366)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(725849038759518371)
,p_plugin_id=>wwv_flow_imp.id(725848132901518366)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(725849353489518371)
,p_plugin_id=>wwv_flow_imp.id(725848132901518366)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(725849685816518372)
,p_plugin_id=>wwv_flow_imp.id(725848132901518366)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(725849990198518372)
,p_plugin_id=>wwv_flow_imp.id(725848132901518366)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(725850297914518372)
,p_plugin_attribute_id=>wwv_flow_imp.id(725849990198518372)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(725850644392518373)
,p_plugin_attribute_id=>wwv_flow_imp.id(725849990198518372)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(725851068445518373)
,p_plugin_id=>wwv_flow_imp.id(725848132901518366)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(725851329991518374)
,p_plugin_attribute_id=>wwv_flow_imp.id(725851068445518373)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(725851733845518375)
,p_plugin_attribute_id=>wwv_flow_imp.id(725851068445518373)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(725852178575518376)
,p_plugin_attribute_id=>wwv_flow_imp.id(725851068445518373)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(725852520218518376)
,p_plugin_id=>wwv_flow_imp.id(725848132901518366)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(725852875976518377)
,p_plugin_attribute_id=>wwv_flow_imp.id(725852520218518376)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(725853252201518377)
,p_plugin_attribute_id=>wwv_flow_imp.id(725852520218518376)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(725853613931518378)
,p_plugin_attribute_id=>wwv_flow_imp.id(725852520218518376)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2237330368010620559)
,p_plugin_id=>wwv_flow_imp.id(725848132901518366)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
